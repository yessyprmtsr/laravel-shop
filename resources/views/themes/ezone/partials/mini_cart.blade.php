<div class="header-cart">
	<a class="icon-cart-furniture" href="{{ url('carts') }}">
		...
		<span class="shop-count-furniture green">{{ \Cart::getTotalQuantity() }}</span> {{--diambil dari quantity cart--}}
    </a>
    {{-- jika ga kosong tampilin list item --}}
	@if (!\Cart::isEmpty())
		<ul class="cart-dropdown">
            {{-- item yang ditampilkan akan dilooping --}}
